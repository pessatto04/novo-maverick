  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>2. Preparação: Configuração do ambiente de testes, ferramentas de gravação, roteiros de introdução e termos de consentimento livre e esclarecido.</li>
        <li>3. Execução: O facilitador guia a sessão orientando o participante a realizar as tarefas e incentiva a técnica de "pensar em voz alta" (think-aloud protocol), registrando o comportamento e os comentários do usuário sem interferir.</li>
